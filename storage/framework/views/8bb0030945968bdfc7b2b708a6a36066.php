...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['title' => 'History','icon' => 'chart','subtitle' => 'Kept for '.e(config('gamemgr.metric_history_days', 30)).' days. Pterodactyl throws these numbers away the moment you close the tab.','xData' => 'metricChart({ url: @js(route(\'server.metrics.series\', [$server, \'range\' => $range])), metric: \'cpu\' })']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'History','icon' => 'chart','subtitle' => 'Kept for '.e(config('gamemgr.metric_history_days', 30)).' days. Pterodactyl throws these numbers away the moment you close the tab.','x-data' => 'metricChart({ url: @js(route(\'server.metrics.series\', [$server, \'range\' => $range])), metric: \'cpu\' })']); ?>
