...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['title' => 'Details']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalae4c123bc9806121d87d234de2f27a3b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalae4c123bc9806121d87d234de2f27a3b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field','data' => ['label' => 'Timezone','required' => true,'hint' => 'Every timestamp in the panel is shown in this zone.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('field'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Timezone','required' => true,'hint' => 'Every timestamp in the panel is shown in this zone.']); ?>
                            <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
...
<?php endif; ?></span>
                            <div class="min-w-0">
                                ...
                                <p class="text-xs text-slate-400"><?php echo e($entry->ip); ?> &middot; <?php echo e($entry->created_at->diffForHumans()); ?></p>
                            </div>
                        </li>
...
<?php $component->withAttributes(['title' => 'Security']); ?>
                <ul class="space-y-2">
                    <li>
                        <a href="<?php echo e(route('settings.password.edit')); ?>" class="flex items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-sm border border-transparent hover:bg-slate-50 hover:border-slate-200 transition">
...
<?php endif; ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('settings.2fa.show')); ?>" class="flex items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-sm border border-transparent hover:bg-slate-50 hover:border-slate-200 transition">
                            <span class="flex items-center gap-2.5 text-slate-700"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('account.api.index')); ?>" class="flex items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-sm border border-transparent hover:bg-slate-50 hover:border-slate-200 transition">
                            <span class="flex items-center gap-2.5 text-slate-700"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php $component->withAttributes(['title' => 'Account']); ?>
                <dl class="space-y-2.5 text-sm">
                    <div class="flex justify-between gap-3"><dt class="text-slate-500">Role</dt><dd class="text-slate-900"><?php echo e($user->isAdmin() ? ($user->isRootAdmin() ? 'Root Admin' : 'Admin') : 'Client'); ?></dd></div>
                    <div class="flex justify-between gap-3"><dt class="text-slate-500">Servers Owned</dt><dd class="tabular text-slate-900"><?php echo e($user->servers()->count()); ?></dd></div>
                    <div class="flex justify-between gap-3"><dt class="text-slate-500">Shared With You</dt><dd class="tabular text-slate-900"><?php echo e($user->subusers()->count()); ?></dd></div>
                    <div class="flex justify-between gap-3"><dt class="text-slate-500">Password Changed</dt><dd class="text-slate-900"><?php echo e($user->password_changed_at?->diffForHumans() ?? 'never'); ?></dd></div>
                </dl>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal53747ceb358d30c0105769f8471417f6)): ?>
