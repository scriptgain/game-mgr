                    ...
                    <dl class="mt-4 space-y-3">
                        <?php if($server->connectAddress()): ?>
                            ...
                            <div class="flex items-start justify-between gap-3 text-sm">
                                ...
                                <dd class="min-w-0 text-right font-mono text-xs text-slate-900 [overflow-wrap:anywhere]"><?php echo e($server->connectAddress()); ?></dd>
                            </div>
                        <?php endif; ?>
                        <div class="flex items-center justify-between text-sm">
                            <dt class="text-slate-500"><?php echo e($server->connectAddress() ? 'Direct' : 'Address'); ?></dt>
