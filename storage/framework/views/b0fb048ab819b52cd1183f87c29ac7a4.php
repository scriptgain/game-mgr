                        ...
                        <div class="px-6 py-4 flex items-center justify-between gap-4">
                            ...
                            <dd class="min-w-0 text-right">
                                <?php if($server->connectAddress()): ?>
                                    <span class="block font-mono text-sm text-slate-900 truncate"><?php echo e($server->connectAddress()); ?></span>
                                    <span class="block font-mono text-xs text-slate-500 truncate"><?php echo e($server->address()); ?></span>
                                <?php else: ?>
                                    <span class="block font-mono text-sm text-slate-900 truncate"><?php echo e($server->address()); ?></span>
                                <?php endif; ?>
                            </dd>
                        </div>
                    <?php endif; ?>
