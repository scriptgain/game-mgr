...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['href' => '#', 'icon' => null, 'active' => false]));
...
foreach (array_filter((['href' => '#', 'icon' => null, 'active' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<a href="<?php echo e($href); ?>"
   ...
   <?php echo e($attributes->merge(['class' => "inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition $classes"])); ?>>
...
<?php /**PATH /var/www/gamemgr/resources/views/components/nav-link.blade.php ENDPATH**/ ?>