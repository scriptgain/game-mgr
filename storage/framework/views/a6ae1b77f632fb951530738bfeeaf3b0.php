...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name', 'value' => '1', 'checked' => false, 'icon' => null]));
...
foreach (array_filter((['name', 'value' => '1', 'checked' => false, 'icon' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<label <?php echo e($attributes->merge(['class' => 'vx-switch'])); ?>>
    <input type="checkbox" name="<?php echo e($name); ?>" value="<?php echo e($value); ?>" <?php if($checked): echo 'checked'; endif; ?>>
...
<?php /**PATH /var/www/gamemgr/resources/views/components/check-switch.blade.php ENDPATH**/ ?>