...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['title' => 'Databases','icon' => 'database','subtitle' => ''.e($databases->count()).' of '.e($server->database_limit ?: 'unlimited').' used.','flush' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Databases','icon' => 'database','subtitle' => ''.e($databases->count()).' of '.e($server->database_limit ?: 'unlimited').' used.','flush' => true]); ?>
