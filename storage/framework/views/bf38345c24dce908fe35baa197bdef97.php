<?php $accent = config('brand.accent'); ?>
<?php if($accent && strtolower($accent) !== '#06b6d4'): ?>
...
<?php endif; ?>
<?php /**PATH /var/www/gamemgr/resources/views/components/accent-style.blade.php ENDPATH**/ ?>