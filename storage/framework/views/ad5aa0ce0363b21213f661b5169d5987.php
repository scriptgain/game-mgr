...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['title', 'subtitle' => null, 'icon' => null, 'back' => null]));
...
foreach (array_filter((['title', 'subtitle' => null, 'icon' => null, 'back' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div <?php echo e($attributes->merge(['class' => 'pb-5'])); ?>>
...
<?php endif; ?>
            ...
            <?php endif; ?>
            <div class="min-w-0">
                <h1 class="text-xl sm:text-2xl font-semibold tracking-tight text-slate-900 truncate"><?php echo e($title); ?></h1>
...
<?php /**PATH /var/www/gamemgr/resources/views/components/page-header.blade.php ENDPATH**/ ?>