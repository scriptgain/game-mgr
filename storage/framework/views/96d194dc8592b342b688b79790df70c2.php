...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['href' => null, 'icon' => null, 'danger' => false]));
...
foreach (array_filter((['href' => null, 'icon' => null, 'danger' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php
    ...
    $tag = $href ? 'a' : 'button';
?>
<<?php echo e($tag); ?> <?php if($href): ?> href="<?php echo e($href); ?>" <?php else: ?> type="button" <?php endif; ?> <?php echo e($attributes->merge(['class' => $classes])); ?>>
...
<?php /**PATH /var/www/gamemgr/resources/views/components/dropdown-item.blade.php ENDPATH**/ ?>