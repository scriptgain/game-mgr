...
<?php
    ...
    $icons = [
        ...
        'sliders' => '<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9m-9 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm-6 0h3m3 6h9m-9 0a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Zm-3 0h-3m15 6h-9m0 0a1.5 1.5 0 0 0-3 0m3 0a1.5 1.5 0 0 1-3 0m0 0h-3" />',
        ...
        // GameMGR additions: game hosting has its own vocabulary.
        'controller' => '<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 9.75v3m1.5-1.5h-3m8.25-.75h.008v.008h-.008v-.008Zm2.25 2.25h.008v.008h-.008v-.008Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M7.125 6.75h9.75a4.875 4.875 0 0 1 4.807 5.7l-.53 3.1A2.625 2.625 0 0 1 18.57 17.7a2.625 2.625 0 0 1-2.16-1.13l-.66-.97H8.25l-.66.97a2.625 2.625 0 0 1-2.16 1.13 2.625 2.625 0 0 1-2.583-2.15l-.53-3.1a4.875 4.875 0 0 1 4.808-5.7Z" />',
        ...
        'fire' => '<path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.048 8.287 8.287 0 0 0 9 9.6a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 4.48Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M12 18a3.75 3.75 0 0 0 .495-7.468 5.99 5.99 0 0 0-1.925 3.547 5.975 5.975 0 0 1-2.133-1.001A3.75 3.75 0 0 0 12 18Z" />',
        ...
        'cpu' => '<path stroke-linecap="round" stroke-linejoin="round" d="M8.25 3v1.5M12 3v1.5M15.75 3v1.5M8.25 19.5V21M12 19.5V21m3.75-1.5V21M3 8.25h1.5M3 12h1.5m-1.5 3.75h1.5M19.5 8.25H21M19.5 12H21m-1.5 3.75H21M6.75 6.75h10.5v10.5H6.75V6.75Zm3 3h4.5v4.5h-4.5v-4.5Z" />',
        'memory' => '<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 7.5h10.5v9H6.75v-9Zm-3 1.5h1.5m-1.5 3h1.5m-1.5 3h1.5m13.5-6H21m-1.5 3H21m-1.5 3H21M9 4.5V6m3-1.5V6m3-1.5V6M9 18v1.5M12 18v1.5M15 18v1.5" />',
        'network' => '<path stroke-linecap="round" stroke-linejoin="round" d="M8.288 15.038a5.25 5.25 0 0 1 7.424 0M5.106 11.856c3.807-3.808 9.98-3.808 13.788 0M1.924 8.674c5.565-5.565 14.587-5.565 20.152 0M12.53 18.22l-.53.53-.53-.53a.75.75 0 0 1 1.06 0Z" />',
        ...
        'upload' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 7.5 12 3m0 0L7.5 7.5M12 3v13.5" />',
        'file' => '<path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25M9 16.5v.75m3-3v3M15 12v5.25m-4.5-15H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />',
        ...
        'bolt-slash' => '<path stroke-linecap="round" stroke-linejoin="round" d="m3 3 18 18M11.412 15.655 9.75 21.75l3.745-4.012M9.257 13.5H3.75l2.659-2.849m2.048-2.194L14.25 2.25 12 10.5h8.25l-4.707 5.043M8.457 8.457 3 3m5.457 5.457 7.086 7.086m0 0L21 21" />',
    ];
?>
<?php
...
?>
<svg <?php echo e($attributes->class(['w-5 h-5' => ! $hasSize])); ?> fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
    <?php echo $icons[$name] ?? ''; ?>

</svg>
<?php /**PATH /var/www/gamemgr/resources/views/components/icon.blade.php ENDPATH**/ ?>