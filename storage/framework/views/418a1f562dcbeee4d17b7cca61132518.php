...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Licence','icon' => 'key','subtitle' => 'Which edition this panel runs as, and what that includes.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Licence','icon' => 'key','subtitle' => 'Which edition this panel runs as, and what that includes.']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <?php if($hasKey): ?>
                <form method="POST" action="<?php echo e(route('settings.licence.recheck')); ?>">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'secondary','size' => 'sm','icon' => 'refresh']); ?>Check Again <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'secondary','icon' => 'settings','href' => ''.e(route('settings.general.edit')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','icon' => 'settings','href' => ''.e(route('settings.general.edit')).'']); ?>Settings <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['title' => 'This Install','icon' => 'shield']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'This Install','icon' => 'shield']); ?>
                <div class="flex flex-wrap items-center gap-3">
                    <span class="inline-flex items-center rounded-full bg-brand-50 px-3 py-1 text-sm font-semibold text-brand-700 ring-1 ring-inset ring-brand-200">
                        <?php echo e(\App\Support\Edition::label($current)); ?> edition
                    </span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status-dot','data' => ['tone' => match ($status['state']) {
                            'valid' => 'success',
                            'grace' => 'warn',
                            'unlicensed' => 'muted',
                            default => 'danger',
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tone' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(match ($status['state']) {
                            'valid' => 'success',
                            'grace' => 'warn',
                            'unlicensed' => 'muted',
                            default => 'danger',
                        }),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(match ($status['state']) {
                            'valid' => 'Licence active',
                            'grace' => 'Running on the last good check',
                            'invalid' => 'Licence not valid',
                            'unverified' => 'Cannot verify',
...
<?php endif; ?>
                ...
                <p class="mt-3 text-sm text-slate-600"><?php echo e($status['message']); ?></p>

                <?php if($status['state'] === 'unlicensed'): ?>
                    <div class="mt-4">
...
<?php endif; ?>
                ...
                <dl class="mt-5 grid gap-3 sm:grid-cols-3 text-sm">
                    ...
                    <div>
                        ...
                        <dd class="text-slate-900"><?php echo e(\Illuminate\Support\Carbon::parse($status['checked_at'])->diffForHumans()); ?></dd>
                    </div>
                </dl>
...
<?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('settings.licence.update')); ?>">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['title' => 'Licence Key','icon' => 'key','subtitle' => 'From your account at scriptgain.com. Leave it empty to run the free edition.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Licence Key','icon' => 'key','subtitle' => 'From your account at scriptgain.com. Leave it empty to run the free edition.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.field','data' => ['label' => 'Key','for' => 'licence_key','error' => $errors->first('licence_key'),'hint' => 'Stored encrypted. It is never written to the audit log.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Key','for' => 'licence_key','error' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->first('licence_key')),'hint' => 'Stored encrypted. It is never written to the audit log.']); ?>
                        <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'licence_key','name' => 'licence_key','value' => ''.e($hasKey ? str_repeat('•', 24) : '').'','placeholder' => 'GM-XXXX-XXXX-XXXX-XXXX','autocomplete' => 'off']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'licence_key','name' => 'licence_key','value' => ''.e($hasKey ? str_repeat('•', 24) : '').'','placeholder' => 'GM-XXXX-XXXX-XXXX-XXXX','autocomplete' => 'off']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','icon' => 'check']); ?>Save Key <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'check','class' => 'mt-0.5 h-3 w-3 shrink-0 text-emerald-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'check','class' => 'mt-0.5 h-3 w-3 shrink-0 text-emerald-600']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                            <span><?php echo e($features[$feature] ?? $feature); ?></span>
                                        </li>
...
<?php endif; ?>
<?php /**PATH /var/www/gamemgr/resources/views/settings/licence.blade.php ENDPATH**/ ?>