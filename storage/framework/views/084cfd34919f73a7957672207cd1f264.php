...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['action', 'icon' => null, 'tone' => 'default', 'confirm' => null, 'confirmTitle' => 'Are You Sure?']));
...
foreach (array_filter((['action', 'icon' => null, 'tone' => 'default', 'confirm' => null, 'confirmTitle' => 'Are You Sure?']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php if($confirm): ?>
    <button type="button" @click="confirming = <?php echo \Illuminate\Support\Js::from($modal)->toHtml() ?>; $dispatch('open-modal', <?php echo \Illuminate\Support\Js::from($modal)->toHtml() ?>)" <?php echo e($attributes->merge(['class' => $classes])); ?>>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => $modal,'title' => $confirmTitle,'icon' => 'warning','tone' => $tone === 'danger' ? 'danger' : 'warn','maxWidth' => 'max-w-md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($modal),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($confirmTitle),'icon' => 'warning','tone' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($tone === 'danger' ? 'danger' : 'warn'),'maxWidth' => 'max-w-md']); ?>
        <p><span x-text="count"></span> selected. <?php echo e($confirm); ?></p>
...
<?php endif; ?>
<?php else: ?>
    <button type="button" @click="submitAs(<?php echo \Illuminate\Support\Js::from($action)->toHtml() ?>)" <?php echo e($attributes->merge(['class' => $classes])); ?>>
        <?php if($icon): ?><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => $icon,'class' => 'w-4 h-4 shrink-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/gamemgr/resources/views/components/mass-action.blade.php ENDPATH**/ ?>