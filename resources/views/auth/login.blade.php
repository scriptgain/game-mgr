    ...
    <div class="lg:w-1/2 bg-chrome text-white px-8 py-12 lg:p-16 flex flex-col justify-between">
        ...
        <div class="hidden lg:block max-w-md">
            ...
            <ul class="mt-8 space-y-3 text-sm text-slate-300">
                <li class="flex items-center gap-2"><x-icon name="check-circle" class="w-5 h-5 text-brand-400" /> Docker, SteamCMD and LinuxGSM, not just containers</li>
                <li class="flex items-center gap-2"><x-icon name="check-circle" class="w-5 h-5 text-brand-400" /> Imports existing template definitions unchanged</li>
                <li class="flex items-center gap-2"><x-icon name="check-circle" class="w-5 h-5 text-brand-400" /> Live console, RCON player control and mod updates</li>
            </ul>
        </div>
